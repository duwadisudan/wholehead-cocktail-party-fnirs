"""Extract MNI xyz triplets from the 4th column of the AtlasViewer CSV.

This utility reads a CSV file whose 4th column stores an "x y z" string,
splits that triplet into three standalone columns, and writes them to a new
CSV (with no header) next to the source file by default.
"""

"""
Script to extract Angular Gyrus ROIs from roi_master.csv
Filters rows where column 2 contains 'Left-AngGyrus (39)' or 'Right-AngGyrus (39)'
Uses scanner_mni.csv for the scanner column (BA column)
"""

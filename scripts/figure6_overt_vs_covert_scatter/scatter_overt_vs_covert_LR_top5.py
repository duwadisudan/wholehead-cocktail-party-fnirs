...
#%%
"""
Overt vs covert (with control) scatter — left/right hemispheres, top-5 ROIs (Figure 6).

For each ROI in the L/R hemisphere top-5 list, extracts the max HbO value
within the 3-10 s post-stimulus window per subject and condition, then plots
overt against covert (and control) per hemisphere. Uses the same per-ROI

"""
Gaze outlier detection — overt-control (distractor) condition (Neon eye tracker).

Reads the aligned physio + events TSVs for the overt-control task,
...
OUTLIER_PARAMS = {
    "overtcontrol": {
        ...
        "expected_right":  -30,
        "tol":             20,
        "analysis_start_s": 0,   # seconds post-onset (after saccade lands)
        "analysis_end_s":   3.0,   # seconds post-onset (steady fixation)

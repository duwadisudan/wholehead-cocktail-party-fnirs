"""
Batch plot gaze (gaze2dX) with event markers — overt-control task (supplementary).

For each subject and run in the configured list, loads the aligned physio
TSV and events TSV for the overt-control task and produces a per-run figure

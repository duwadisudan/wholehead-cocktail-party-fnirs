...
# -*- coding: utf-8 -*-
"""
Permutation-test analysis for the KNN classifier (supplementary).

Loads per-subject permutation-test outputs from the KNN classifier pipeline
...
def main():
    ...
    analysis_file = os.path.join(output_dir, "permutation_significance_analysis.pkl")
